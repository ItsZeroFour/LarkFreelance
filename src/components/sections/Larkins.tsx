  ...
  return (
    <Section id="larkins-brief">
      <SectionHeading
        ...
        description="Если готовы рассказать задачу подробно - пять вопросов, и коммерческое предложение собирается на глазах. Нужен просто звонок - форма с номером ждёт в контактах внизу страницы."
      />
